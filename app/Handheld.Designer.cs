...
namespace GHelper
{
    partial class Handheld
    {
        ...
        private void InitializeComponent()
        {
            ...
            comboBindingMode = new GHelper.UI.RComboBox();
            buttonCC = new GHelper.UI.RButton();
            buttonROG = new GHelper.UI.RButton();
            ...
            panelSoftwareBinding = new Panel();
            labelSoftwareBinding = new Label();
            comboSoftware = new UI.RComboBox();
            textSoftware = new TextBox();
            labelSoftwareSecondary = new Label();
            comboSoftwareSecondary = new UI.RComboBox();
            textSoftwareSecondary = new TextBox();
            labelSoftwareDouble = new Label();
            comboSoftwareDouble = new UI.RComboBox();
            textSoftwareDouble = new TextBox();
            ...
            panelSoftwareBinding.SuspendLayout();
            ...
            panelBindings.Controls.Add(panelSoftwareBinding);
            panelBindings.Controls.Add(buttonCC);
            panelBindings.Controls.Add(buttonROG);
            ...
            panelBindings.Controls.Add(comboBindingMode);
            ...
            // comboBindingMode
            // 
            comboBindingMode.BorderColor = Color.White;
            comboBindingMode.ButtonColor = Color.FromArgb(255, 255, 255);
            comboBindingMode.DropDownStyle = ComboBoxStyle.DropDownList;
            comboBindingMode.FlatStyle = FlatStyle.Flat;
            comboBindingMode.Font = new Font("Segoe UI", 9F);
            comboBindingMode.FormattingEnabled = true;
            comboBindingMode.Location = new Point(540, 32);
            comboBindingMode.Name = "comboBindingMode";
            comboBindingMode.Size = new Size(295, 40);
            comboBindingMode.TabIndex = 40;
            // 
            // buttonCC
            // 
            buttonCC.Activated = false;
            buttonCC.BackColor = SystemColors.ControlLight;
            buttonCC.BorderColor = Color.Transparent;
            buttonCC.BorderRadius = 5;
            buttonCC.FlatAppearance.BorderSize = 0;
            buttonCC.FlatStyle = FlatStyle.Flat;
            buttonCC.ForeColor = SystemColors.ControlText;
            buttonCC.ImageAlign = ContentAlignment.MiddleRight;
            buttonCC.Location = new Point(175, 89);
            buttonCC.Margin = new Padding(4);
            buttonCC.Name = "buttonCC";
            buttonCC.Secondary = true;
            buttonCC.Size = new Size(147, 55);
            buttonCC.TabIndex = 39;
            buttonCC.Text = "Cmd Center";
            buttonCC.TextImageRelation = TextImageRelation.ImageBeforeText;
            buttonCC.UseVisualStyleBackColor = false;
            // 
            // buttonROG
            // 
            buttonROG.Activated = false;
            buttonROG.BackColor = SystemColors.ControlLight;
            buttonROG.BorderColor = Color.Transparent;
            buttonROG.BorderRadius = 5;
            buttonROG.FlatAppearance.BorderSize = 0;
            buttonROG.FlatStyle = FlatStyle.Flat;
            buttonROG.ForeColor = SystemColors.ControlText;
            buttonROG.ImageAlign = ContentAlignment.MiddleRight;
            buttonROG.Location = new Point(1052, 89);
            buttonROG.Margin = new Padding(4);
            buttonROG.Name = "buttonROG";
            buttonROG.Secondary = true;
            buttonROG.Size = new Size(147, 55);
            buttonROG.TabIndex = 40;
            buttonROG.Text = "ROG";
            buttonROG.TextImageRelation = TextImageRelation.ImageBeforeText;
            buttonROG.UseVisualStyleBackColor = false;
            // 
            // panelSoftwareBinding
            // 
            panelSoftwareBinding.Controls.Add(labelSoftwareBinding);
            panelSoftwareBinding.Controls.Add(comboSoftware);
            panelSoftwareBinding.Controls.Add(textSoftware);
            panelSoftwareBinding.Controls.Add(labelSoftwareSecondary);
            panelSoftwareBinding.Controls.Add(comboSoftwareSecondary);
            panelSoftwareBinding.Controls.Add(textSoftwareSecondary);
            panelSoftwareBinding.Controls.Add(labelSoftwareDouble);
            panelSoftwareBinding.Controls.Add(comboSoftwareDouble);
            panelSoftwareBinding.Controls.Add(textSoftwareDouble);
            panelSoftwareBinding.Location = new Point(397, 192);
            panelSoftwareBinding.Name = "panelSoftwareBinding";
            panelSoftwareBinding.Size = new Size(583, 335);
            panelSoftwareBinding.TabIndex = 38;
            panelSoftwareBinding.Visible = false;
            // 
            // labelSoftwareBinding
            // 
            labelSoftwareBinding.AutoSize = true;
            labelSoftwareBinding.Font = new Font("Segoe UI", 9F, FontStyle.Bold, GraphicsUnit.Point);
            labelSoftwareBinding.Location = new Point(33, 20);
            labelSoftwareBinding.Name = "labelSoftwareBinding";
            labelSoftwareBinding.Size = new Size(103, 32);
            labelSoftwareBinding.TabIndex = 2;
            labelSoftwareBinding.Text = "Binding:";
            // 
            // comboSoftware
            // 
            comboSoftware.BorderColor = Color.White;
            comboSoftware.ButtonColor = Color.FromArgb(255, 255, 255);
            comboSoftware.DropDownStyle = ComboBoxStyle.DropDownList;
            comboSoftware.FormattingEnabled = true;
            comboSoftware.Location = new Point(38, 70);
            comboSoftware.Name = "comboSoftware";
            comboSoftware.Size = new Size(300, 40);
            comboSoftware.TabIndex = 0;
            // 
            // textSoftware
            // 
            textSoftware.Location = new Point(345, 70);
            textSoftware.Name = "textSoftware";
            textSoftware.Size = new Size(200, 39);
            textSoftware.TabIndex = 1;
            textSoftware.Visible = false;
            // 
            // labelSoftwareSecondary
            // 
            labelSoftwareSecondary.AutoSize = true;
            labelSoftwareSecondary.Font = new Font("Segoe UI", 9F, FontStyle.Bold, GraphicsUnit.Point);
            labelSoftwareSecondary.Location = new Point(33, 130);
            labelSoftwareSecondary.Name = "labelSoftwareSecondary";
            labelSoftwareSecondary.Size = new Size(103, 32);
            labelSoftwareSecondary.TabIndex = 3;
            labelSoftwareSecondary.Text = "Secondary (M1/M2):";
            // 
            // comboSoftwareSecondary
            // 
            comboSoftwareSecondary.BorderColor = Color.White;
            comboSoftwareSecondary.ButtonColor = Color.FromArgb(255, 255, 255);
            comboSoftwareSecondary.DropDownStyle = ComboBoxStyle.DropDownList;
            comboSoftwareSecondary.FormattingEnabled = true;
            comboSoftwareSecondary.Location = new Point(38, 180);
            comboSoftwareSecondary.Name = "comboSoftwareSecondary";
            comboSoftwareSecondary.Size = new Size(300, 40);
            comboSoftwareSecondary.TabIndex = 4;
            // 
            // textSoftwareSecondary
            // 
            textSoftwareSecondary.Location = new Point(345, 180);
            textSoftwareSecondary.Name = "textSoftwareSecondary";
            textSoftwareSecondary.Size = new Size(200, 39);
            textSoftwareSecondary.TabIndex = 5;
            textSoftwareSecondary.Visible = false;
            // 
            // labelSoftwareDouble
            // 
            labelSoftwareDouble.AutoSize = true;
            labelSoftwareDouble.Font = new Font("Segoe UI", 9F, FontStyle.Bold, GraphicsUnit.Point);
            labelSoftwareDouble.Location = new Point(33, 225);
            labelSoftwareDouble.Name = "labelSoftwareDouble";
            labelSoftwareDouble.Size = new Size(148, 32);
            labelSoftwareDouble.TabIndex = 6;
            labelSoftwareDouble.Text = "Double click:";
            // 
            // comboSoftwareDouble
            // 
            comboSoftwareDouble.BorderColor = Color.White;
            comboSoftwareDouble.ButtonColor = Color.FromArgb(255, 255, 255);
            comboSoftwareDouble.DropDownStyle = ComboBoxStyle.DropDownList;
            comboSoftwareDouble.FormattingEnabled = true;
            comboSoftwareDouble.Location = new Point(38, 270);
            comboSoftwareDouble.Name = "comboSoftwareDouble";
            comboSoftwareDouble.Size = new Size(300, 40);
            comboSoftwareDouble.TabIndex = 7;
            // 
            // textSoftwareDouble
            // 
            textSoftwareDouble.Location = new Point(345, 270);
            textSoftwareDouble.Name = "textSoftwareDouble";
            textSoftwareDouble.Size = new Size(200, 39);
            textSoftwareDouble.TabIndex = 8;
            ...
            panelSoftwareBinding.ResumeLayout(false);
            panelSoftwareBinding.PerformLayout();
        ...
        private UI.RComboBox comboBindingMode;
        ...
        private GHelper.UI.RButton buttonCC;
        private GHelper.UI.RButton buttonROG;
        ...
        private Panel panelSoftwareBinding;
        private Label labelSoftwareBinding;
        private UI.RComboBox comboSoftware;
        private TextBox textSoftware;
        private Label labelSoftwareSecondary;
        private UI.RComboBox comboSoftwareSecondary;
        private TextBox textSoftwareSecondary;
        private Label labelSoftwareDouble;
        private UI.RComboBox comboSoftwareDouble;
        private TextBox textSoftwareDouble;
    }
}
