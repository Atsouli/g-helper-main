...
namespace GHelper
{
    ...
    static class Program
    {
        ...
        public static RtssOverlay? rtssOverlay;
        public static ControllerMappingPreview? controllerMappingPreview;
        ...
        public static GamepadTdpControl? gamepadTdpControl;
        ...
        public static void Main(string[] args)
        {
            ...
            gamepadTdpControl = new GamepadTdpControl();
        ...
        {
            gamepadTdpControl?.Dispose();
            controllerMappingPreview?.Dispose();
            rtssOverlay?.Dispose();
